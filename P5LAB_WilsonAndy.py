...
def main():
    ...
    changed_owed = cust_input - final_total
    # changed_owed will converted ex; .83 to 83 so it can run 

    print()
    print(f"Change owed to customer: ${changed_owed:.2f}")
    print()

    changed_owed = round(changed_owed *100)

    
    #print(f"${final_total:.2f}")

    disperse_change(changed_owed)
